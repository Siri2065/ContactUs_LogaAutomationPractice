...
public class msgenotenteredpages {
	WebDriver driver;
	public msgenotenteredpages(WebDriver driver)
	{
		this.driver=driver;
	}
...
public void Click_ContactLOGA() throws IOException
{
	...
	FileUtils.copyFile(f, new File("D:\\Selenium\\eclipse\\ContactLOGA\\Screenshots\\Msgnotentered.png"));
}
